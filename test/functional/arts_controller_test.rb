...
class ArtsControllerTest < ActionController::TestCase
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post :create, art: { artist: @art.artist, created_on: @art.created_on, medium: @art.medium, name: @art.name, photo: @art.photo, style: @art.style }
    end
  ...
  test "should update art" do
    put :update, id: @art, art: { artist: @art.artist, created_on: @art.created_on, medium: @art.medium, name: @art.name, photo: @art.photo, style: @art.style }
    assert_redirected_to art_path(assigns(:art))
  end
